class Cricket
{
  ...
  public static void cricketTeamIndia()
  {
	  ...
	  System.out.println("Rohit Sharma scored"+rohitSharma+"runs in T20 fianl match");
	  System.out.println("viratkohli scored"+viratkohli+"runs in T20 fianl match");
	  System.out.println("Rishabh Pant scored"+rishabhPant+"runs in T20 fianl match");
	  System.out.println("SuryaKumar Yadav scored"+suryaKumarYadav+"runs in T20 fianl match");
	  System.out.println("Axar Patel scored"+axarPatel+"runs in T20 fianl match");
	  System.out.println("Shivam Dube scored"+shivamDube+"runs in T20 fianl match");
	  System.out.println("Hardik Pandya scored"+hardikPandya+"runs in T20 fianl match");
	  System.out.println("Ravindra Jadeja scored"+ravindraJadeja+"runs in T20 fianl match");
  }
   public static void cricketTeamSouthAfrica()
  {
	  ...
	  int kagisoRabada=4;
	  int anrichNortje=1;
	  System.out.println("Reeza Hendricks scored"+reezaHendricks+"runs in T20 fianl match");
	  System.out.println("Quinton de Kock scored"+quintondeKock+"runs in T20 fianl match");
	  System.out.println("Aiden Markram scored"+aidenMarkram+"runs in T20 fianl match");
	  System.out.println("Tristan Stubbs scored"+tristanStubbs+"runs in T20 fianl match");
